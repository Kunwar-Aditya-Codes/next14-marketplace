...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfinteProducts: trpc_1.publicProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, queryOptions, payload, parsedQueryOptions, page, _b, items, nextPage, hasNextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _b = _c.sent(), items = _b.docs, nextPage = _b.nextPage, hasNextPage = _b.hasNextPage;
                        return [2 /*return*/, {
                                items: items,
